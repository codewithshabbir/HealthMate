...
const analyzeFile = async (req, res) => {
    try {
      ...
      Provide:
      1. A short summary.
      2. Key abnormal values or findings (if any).
      3. A few simple health recommendations.
      4. Always end with: "This summary is for understanding only, not for medical advice."
